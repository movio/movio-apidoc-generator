...
class Kafka10ProducerSpec extends FunSpec with ShouldMatchers {
  import KafkaUtil._
  ...
  it("generates kafka producer") {
    val generated = Kafka10Producer.generateCode(form)

    models.TestHelper.assertEqualsFile(
      "/kafka-10-producer.txt",
